namespace SpriteKind {
    export const Dano = SpriteKind.create()
}
...
let balacabum: Sprite = null
let projectile: Sprite = null
let palito: Sprite = null
let dano = sprites.create(img`
    2 
    2 
    2 
    2 
    ...
    2 
    `, SpriteKind.Dano)
dano.setPosition(5, 60)
palito = sprites.create(img`
    ........ffff.........
    .......f1111f........
    ......f11f1f1f.......
    ......f11f1f1f.......
    ...
    .....................
    `, SpriteKind.Player)
controller.moveSprite(palito, 70, 70)
palito.setStayInScreen(true)
info.setLife(1)
...
game.onUpdateInterval(randint(2000, 2500), function () {
    balacabum = sprites.create(img`
        ...
        .....................
        `, SpriteKind.Enemy)
    balacabum.setVelocity(-7, 0)
    balacabum.setPosition(170, randint(110, 15))
    balacabum.setFlag(SpriteFlag.AutoDestroy, false)
})
